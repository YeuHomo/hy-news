		...
		<view class="home-list">
			<view v-if="is_history" class="label-box">
				...
				<view v-if="historyLists.length>0" class="label-content">
					<view class="label-content__item" v-for="item in historyLists" :key="item.id" @click="openHistory(item)">{{item.name}}</view>
				</view>
			...
			<list-scroll v-else class="list-scroll">
				...
				<view v-if="searchList.length>0">
					<list-card mode="base" v-for="item in searchList" :key="item._id" :item="item" @saveHistory="setHistory"></list-card>
				</view>
